...
//---------------------------------------------------------------------------------------------
define('API_KEY', '8830969195:AAFXc3v0zsM-8XujOjaiTVFxA5W1dIxVQsU'); // توکن ربات رو به جای عبارت TOKEN قرار بدید
$admins = [7761540434,7015879742,6707399737,1317073026,6788568011,2022010806,5958639761,6389723091,8408591942]; // آیدی عددی ادمین های ربات رو در این آرایه قرار بدید قرار بدید
